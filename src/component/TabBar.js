...
export default class TabBar extends Component {
    ...
    static propTypes = {
        ...
        seletedItem : React.PropTypes.number,
    };
    constructor(props) {
        super(props);
        this.visibles = [];
    ...
    componentWillReceiveProps(nextProps){
        if(nextProps.seletedItem && nextProps.seletedItem >= 0 && nextProps.seletedItem <= 3) {
            this.update(nextProps.seletedItem);
        }else{
            return;
        }
    }
